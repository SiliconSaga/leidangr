...
- **The grafts** — how the aspect gets applied: `template.yaml` (the Create-page door — a scaffolder Template) and `SKILL.md` (the agent door, for practitioners who never leave their CLI). Both read this same module.
