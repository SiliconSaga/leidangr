...
Point it at whoever should hear about findings first — usually the owning team, sometimes a named individual. The trial flips green on the next catalog refresh. If nobody obvious exists, ask in `#security-gildi`: naming a reluctant contact beats having none.
